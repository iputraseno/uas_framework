...
<head>
    ...
    <title>Edit Jabatan - Space Theme</title>
    ...
    <style>
        ...
        input:focus, select:focus, button:focus {
            background-color: rgba(6, 37, 241, 0.5s);
            color: white;
            outline: none;
        }
...
<body>
    ...
    <div class="container">
        ...
        <form action="<?= site_url('jabatancontroller/update/'.$jabatan->id); ?>" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select id="nama_jabatan" name="nama_jabatan" class="form-select" required>
                    <?php foreach ($nama_jabatan_options as $option): ?>
                        <option value="<?= $option; ?>" <?= $jabatan->nama_jabatan == $option ? 'selected' : ''; ?>>
                            <?= $option; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
